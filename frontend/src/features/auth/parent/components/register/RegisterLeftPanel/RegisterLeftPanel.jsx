...
const RegisterLeftPanel = () => {
  ...
  return (
    <div className="hidden lg:flex flex-col justify-center h-screen bg-gradient-to-br from-[#0a1628] via-[#1a2a4a] to-[#0d1b2a] p-12 text-white relative overflow-hidden">
